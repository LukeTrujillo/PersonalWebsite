<div class="container bg-dark" id="jumbotron-div">
  <div class="row businesscard text-white">
    <div class="col businesscard-img-div p-4 d-block my-auto">
      <img src="/img/trujillo.jpeg" class="img-fluid rounded-circle d-block mx-auto my-auto">
    </div>
    <div class="col-12 col-lg-6 py-4 my-auto text-center text-lg-left">
      ...
      <div class="d-block mb-auto">
        ...
        <form class="px-5 px-lg-0">
            ...
            <div class="form-row">
              <div class="col-9">
                    <input type="email" class="form-control mb-2 mr-sm-2" placeholder="Enter your email address...">
              </div>
              <div class="col-3">
